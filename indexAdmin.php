...
<body>
    ...
    <section class="HomeServicios">
        ...
        <h3 class="responsiveTitle">Vestidos de 15</h3>
        ...
        <div class="tarjetasService">
            <h3 class="responsiveTitle">Disfraces</h3>
            <div class="bg_tajetas2"></div>
            <div class="textContent">
                <h3>Disfraces</h3>
                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum .</p>
        ...
        <div class="tarjetasService">
        <h3 class="responsiveTitle">Vestidos de Fiesta</h3>
